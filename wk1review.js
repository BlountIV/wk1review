...
if(grade >= 90){
  ...
  console.log('You get $25')
} else if(grade >= 70){
  console.log('You get $15')
} else if(grade >= 55){
  console.log('You get $5')
} else {
  console.log('You get nothing. Better grades get money')
}
...
let time = 1400 // had to convert the time frames into military time in order for this to work.
if(time <= 0500 - 1159){ 
  console.log("Good Morning")
} else if( time >= 1200 - 1600){
...
const One = 'Sabrina' 
console.log(`${One.charAt(4)}`);


// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy  (Unicode gives a unique number to character across languages and scripts. Making almost all characters accessible across platforms, programs, devices.)

const Two = 'Teddy' 
console.log(`${Two.charCodeAt(3)}`);
...
// push() adding an item to the end of the array
